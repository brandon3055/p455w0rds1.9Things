...
import p455w0rd.p455w0rdsthings.inventory.slot.FurnaceSlot;

public class ContainerFurnace extends Container {

	protected TileEntityFurnace tileEntity;

	public ContainerFurnace(InventoryPlayer inventoryPlayer, TileEntityFurnace te) {
		tileEntity = te;

		// Input Slot
		addSlotToContainer(new FurnaceSlot(tileEntity, 0, 49, 18));

		// Output Slot
		addSlotToContainer(new FurnaceSlot(tileEntity, 1, 106, 18));
