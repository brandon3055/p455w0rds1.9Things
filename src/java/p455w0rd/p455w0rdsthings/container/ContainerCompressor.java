...
import p455w0rd.p455w0rdsthings.inventory.slot.CompressorSlot;
...
public class ContainerCompressor extends Container {
	...
	public ContainerCompressor(InventoryPlayer inventoryPlayer, TileEntityCompressor te) {
		...
		// Input Slot
		addSlotToContainer(new CompressorSlot(tileEntity, 0, 49, 18));

		// Output Slot
		addSlotToContainer(new CompressorSlot(tileEntity, 1, 106, 18));
